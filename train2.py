...
message = tk.Label(window, text="ATTENDANCE MANAGEMENT SYSTEM", bg="Green", fg="white", width=50, height=3,
...
copyWrite.insert("insert", "Developed by Debottam", "", "TEAM", "superscript")
